...
<?= Form::open(array('url' => 'save_video' ,'enctype'=>'multipart/form-data')) ?>
	...
	<div class="row">
		...
		<div class=" col-md-6 form-group">
			...
			<?php echo Form::text('video_name', $value = $video->name, $attributes = array('class="form-control" placeholder="Name"')); ?>
			
		</div>
		<div class=" col-md-6 form-group">
			<?php echo Form::label('videotags', 'Set Tags'); ?>
			<?php echo Form::text('video_tags', $value = $video->video_name, $attributes = array('class="form-control" placeholder="Tags"')); ?>
	...
	<div class=" row form-group">
		<div class="col-md-6 form-group">
			...
			<?php echo Form::textarea('video_description', $value = $video->disctription, $attributes = array('class="form-control" placeholder="Description" rows="2"')); ?>
